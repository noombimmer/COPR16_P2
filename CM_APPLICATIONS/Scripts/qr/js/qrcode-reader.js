;(function( $, window, document, undefined ) {
  ...
  $.qrCodeReader = {
      jsQRpath: "/Scripts/qr/js/jsQR/jsQR.min.js",
      beepPath: "/Scripts/qr/audio/beep.mp3",
    instance: null,
    defaults: {
  ...
  QRCodeReader.prototype = {
    ...
    buildHTML: function () {
      ...
      //qrr.okBtn = $('<a id="qrr-ok">OK</a>');
          ...
          qrr.loadingMessage = $('<div id="qrr-loading-message"></div>');
    ...
    open: function () {
      ...
      qrr.getOptions(this);
        var targetName = qrr.settings.target;
        console.log(targetName);
        console.log($(targetName));
        var parentObject = $(targetName).parent();
        console.log(parentObject);
        //qrr.container.appendTo(parentObject);
        qrr.container.insertBefore(targetName);
