...
var $jscomp = $jscomp || {};
$jscomp.scope = {};
$jscomp.findInternal = function (c, e, f) {
    c instanceof String && (c = String(c));
    for (var k = c.length, h = 0; h < k; h++) {
        var n = c[h];
        if (e.call(f, n, h, c))
            return {
                i: h,
...
$jscomp.polyfill = function (c, e, f, k) {
    e && ($jscomp.ISOLATE_POLYFILLS ? $jscomp.polyfillIsolated(c, e, f, k) : $jscomp.polyfillUnisolated(c, e, f, k))
};
$jscomp.polyfillUnisolated = function (c, e, f, k) {
    f = $jscomp.global;
    c = c.split(".");
    ...
    k = f[c];
    e = e(k);
    e != k && null != e && $jscomp.defineProperty(f, c, {
        configurable: !0,
        writable: !0,
        value: e
    })
...
$jscomp.polyfillIsolated = function (c, e, f, k) {
    ...
    h = h[h.length - 1];
    f = $jscomp.IS_SYMBOL_NATIVE && "es6" === f ? k[h] : null;
    e = e(f);
    null != e && (c ? $jscomp.defineProperty($jscomp.polyfills, h, {
            configurable: !0,
            writable: !0,
            value: e
        }) : e !== f && ($jscomp.propertyToPolyfillSymbol[h] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(h) : $jscomp.POLYFILL_PREFIX + h, h =
                $jscomp.propertyToPolyfillSymbol[h], $jscomp.defineProperty(k, h, {
                configurable: !0,
                writable: !0,
                value: e
            })))
...
(function (c) {
    ...
    c.extend(m.prototype, {
        ...
        _constructor: function () {
            var a = this,
            b = this.s.dt;
            c(e).on("scroll" + this.s.namespace,
                function () {
                a._scroll()
            }).on("resize" + this.s.namespace, h.util.throttle(function () {
                    a.s.position.windowHeight = c(e).height();
                    a.update()
                }, 50));
            var g = c(".fh-fixedHeader");
            !this.c.headerOffset && g.length && (this.c.headerOffset = g.outerHeight());
            g = c(".fh-fixedFooter");
            !this.c.footerOffset && g.length && (this.c.footerOffset = g.outerHeight());
        ...
        _clone: function (a, b) {
            var g = this.s.dt,
            d = this.dom[a],
            l = "header" === a ? this.dom.thead : this.dom.tfoot;
        ...
        _matchWidths: function (a, b) {
            var g = function (q) {
                return c(q, a).map(function () {
                    return 1 * c(this).css("width").replace(/[^\d\.]/g, "")
                }).toArray()
            },
            d = function (q, r) {
                c(q, b).each(function (p) {
                    c(this).css({
                        width: r[p],
                        minWidth: r[p]
                    })
        ...
        _horizontal: function (a, b) {
            ...
            d = this.s.position,
            l = this.s.scrollLeft;
            g.floating && l[a] !== b && (g.floating.css("left", d.left - b), l[a] = b)
        },
        _modeChange: function (a, b, g) {
            var d = this.dom[b],
            l = this.s.position,
            q = function (t) {
                d.floating.attr("style", function (v, u) {
                    return (u || "") + "width: " + t + "px !important;"
                })
            },
            r = this.dom["footer" === b ? "tfoot" : "thead"],
            p = c.contains(r[0], f.activeElement) ? f.activeElement : null;
            p && p.blur();
            "in-place" === a ? (d.placeholder && (d.placeholder.remove(), d.placeholder =
                    ...
                    l.tbodyTop).css("left", l.left + "px"), q(l.width));
            p && p !== f.activeElement && setTimeout(function () {
                p.focus()
            }, 10);
        ...
        _positions: function () {
            ...
            b.tbodyTop = g.offset().top;
            b.tbodyHeight = g.outerHeight();
            b.theadHeight =
                b.tbodyTop - b.theadTop;
            l.length ? (b.tfootTop = l.offset().top, b.tfootBottom = b.tfootTop + l.outerHeight(), b.tfootHeight = b.tfootBottom - b.tfootTop) : (b.tfootTop = b.tbodyTop + g.outerHeight(), b.tfootBottom = b.tfootTop, b.tfootHeight = b.tfootTop)
        },
        _scroll: function (a) {
            var b = c(f).scrollTop(),
            g = c(f).scrollLeft(),
            d = this.s.position;
            if (this.c.header) {
                var l = this.s.enable ? !d.visible || b <= d.theadTop - this.c.headerOffset ? "in-place" : b <= d.tfootTop - d.theadHeight - this.c.headerOffset ? "in" : "below" : "in-place";
                (a || l !== this.s.headerMode) &&
                this._modeChange(l, "header", a);
                this._horizontal("header", g)
            }
    ...
    c.fn.DataTable.FixedHeader =
        m;
    c(f).on("init.dt.dtfh", function (a, b, g) {
        "dt" === a.namespace && (a = b.oInit.fixedHeader, g = h.defaults.fixedHeader, !a && !g || b._fixedHeader || (g = c.extend({}, g, a), !1 !== a && new m(b, g)))
    });
    ...
    c.each(["header", "footer"], function (a, b) {
        h.Api.register("fixedHeader." + b + "Offset()", function (g) {
            var d = this.context;
            return g === k ? d.length && d[0]._fixedHeader ? d[0]._fixedHeader[b + "Offset"]() : k : this.iterator("table", function (l) {
                if (l =
                        l._fixedHeader)
                    l[b + "Offset"](g)
            })
